...
products_mock_data = [
    {
        ...
        'image': 'uploads/products/brinco_destaque2.jpeg', # CERTIFIQUE-SE DE QUE ESTA IMAGEM EXISTE NO SEU CAMINHO
        'price': 180.00,
        'old_price': 220.00,
        'installments': 4,
    ...
    },
    {
        'id': 5,
        'name': 'Brinco perola',
        'image': 'uploads/products/brinco_perola.jpeg', # Exemplo de imagem nova, ajuste
        'price': 350.00,
        'old_price': None,
        'installments': 7,
    ...
    },
    {
        ...
        'image': 'uploads/products/brinco_destaque.jpeg', # Exemplo de imagem nova, ajuste
        'price': 499.00,
        'old_price': 550.00,
        'installments': 8,
